!(function (e, t) {
  ...
  function G(e) {
    ...
    (y = !0),
      ...
      (P = e.hasAttribute("data-autoplay") || e.settings.autoplay),
      (E = e.getAttribute("data-href") || e.getAttribute("href")),
  ...
  function J() {
    return (
      ...
      (!r.settings.onPreClose ||
        ...
        (r.settings.onPreClose(r, p, j, H), !1 !== r.settings.onPreClose)) &&
  ...
  function se(e, t, o) {
    ...
    if ("vimeo" == s.type || "youtube" == s.type) {
      ...
      "vimeo" == s.type
        ...
        : "youtube" == s.type && (i = "https://www.youtube.com/embed/"),
        (x =
